  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-12 d-flex no-block align-items-center">
        <h4 class="page-title">Rooms Servies  </h4>
          ...
          <div class="row">
              <div class="col col-md-8"></div>
                <div class="col col-md-4">
                  <a href="{{ route('rooms_services.create') }}"class="btn btn-success btn-sm float-end">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                    </svg>&nbsp;&nbsp;Add Room Servie </a>
              </div>
              ...
              <tr>
                ...
                <td >
                  {{-- <span class="btn btn-sm bg-success-light"> --}}
                    {{ $room->status }}</td>
                <td>
                    <form action="{{ route('rooms_services.destroy',$room->id) }}" method="Post">
                        ...
                        <a class="btn btn-primary" href="{{ route('rooms_services.edit',$room->id) }}">
