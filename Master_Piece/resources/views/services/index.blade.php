      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-dark table-striped table-hover">
              <tr>
                <th width="70px">#</th>
                <th width="12%">Image Service</th>
                <th width="12%">Name Service</th>
                <th>Detail Service</th>

                
                <th scope="col" width="12%" colspan="3">Action</th>
              </tr>
              @foreach($services as $service)
              
              <tr>
                <td>{{ $service->id }}</td>
                <td><img src="/images/{{ $service->image  }}" width="100px" height="100px"></td>
