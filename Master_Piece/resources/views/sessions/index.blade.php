          ...
          <div class="row">
              <div class="col col-md-8"></div>
                <div class="col col-md-4">
                  <a href="{{ route('sessions.create') }}"class="btn btn-success btn-sm float-end">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                    </svg>&nbsp;&nbsp;Add New Sessions </a>
              </div>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-dark table-striped table-hover">
              ...
              <tr>
                <td>{{ $session->id }}</td>
                <td>{{ $session->name_service }}</td>
                <td>{{ $session->name_room }}</td>
                <td>{{ $session->name_session }}</td>
                <td>{{ $session->cost_session }} JOD</td>
                <td>{{ $session->detail_session}}</td>
                ...
                <td>
                    <form action="{{ route('sessions.destroy',$session->id) }}" method="Post">
                        ...
                        <a class="btn btn-primary" href="{{ route('sessions.edit',$session->id) }}">
