                                    ...
                                    <form action="{{ route('register') }}" class="forms-group" method="post">
                                        ...
                                        @if (session('error') === '')
                                            <div class="alert alert-success">
                                                Register new user successfully, Please login into your account to complete
                                                setup forms!
                                            </div>
                                        @endif
                                        <div class="form-outline mb-4">
                                            ...
                                            <input id="firstname" type="text"
                                                class="form-control form-control-lg input-text @error('firstname') is-invalid @enderror"
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input id="lastname" type="text"
                                                class="form-control form-control-lg input-text @error('lastname') is-invalid @enderror"
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input id="phone" type="tel"
                                                class="form-control form-control-lg input-text @error('phone') is-invalid @enderror"
                                        ...
                                        <div class="d-grid gap-2 col-12 mx-auto mb-4">
                                            ...
                                            <button name="register" type="submit " class="btn btn-info btn-lg text-white"
                                                value="Sign up">Sign up</button>
                                        </div>

                                        <a href="{{ route('login') }}" class="d-block mt-3 text-muted">Have an account?
                                            Login</a>
