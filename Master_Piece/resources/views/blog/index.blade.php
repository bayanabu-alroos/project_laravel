          ...
          <div class="row">
              <div class="col col-md-8"></div>
                <div class="col col-md-4">
                  <a href="{{ route('blog.create') }}"class="btn btn-success btn-sm float-end">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-dark table-striped table-hover">
              ...
              @foreach($blogs as $blog)
                      ...
                      <tr>
                          <td>{{ ++$i }}</td>
                          <td><img src="/images/{{ $blog->image }}" width="100px" height="100px"></td>
                          <td>{{ $blog->title }}</td>
                          <td>{{ $blog->article }}</td>
                          ...
                          <td>
                            <form action="{{ route('blog.destroy',$blog->id) }}" method="Post">
                              ...
                              <a class="btn btn-info" href="{{ route('blog.show',$blog->id) }}">
